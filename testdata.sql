...
insert into users values ('Order', 'Order', 'a', '7777', to_date('2042-12-24','yyyy-mm-dd')); 
...
insert into users values ('Harmony', 'Harmony', 's', '4251', to_date('2042-12-27', 'yyyy-mm-dd'));

insert into users values ('Dr.Nope', 'Dr.Nope', 's', '1213', to_date('2042-12-27', 'yyyy-mm-dd'));

insert into users values ('Discord', 'Discord', 'd', '1213', to_date('2042-12-27', 'yyyy-mm-dd'));

insert into users values ('Privateer', 'Privateer', 'd', '9821', to_date('2043-01-01', 'yyyy-mm-dd'));
