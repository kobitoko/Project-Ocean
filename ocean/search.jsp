...
<script>permission = 'scientist';</script>
 ...
 <form action="executeSearch.jsp" method="post">
     ...
     <tr><td> <p style="display:inline">Sensor Type: </p></td><td><input type="text" onclick="verifyTime()" id="stype" size="32" name="stype" maxlength="1"  placeholder="Sensor Type"><br></td></tr>
