...
<script>permission = 'scientist';</script>
 ...
 <form action="executeSearch.jsp" method="post">
     ...
     <tr><td> <p style="display:inline">Sensor Type: </p></td><td><input type="text" onblur="verifyTime()" id="stype" size="32" name="stype" maxlength="1"  placeholder="Sensor Type"><br></td></tr>
      ...
      <tr><td><p style="display:inline">Data Since: (dd/mm/yyyy hh:mm:ss)</p></td><td><input id="dateSince" name="dateSince" type="text" pattern="((3[01]|[12][0-9]|0[1-9])[/](1[02]|0[13578])|(3[0]|[12][0-9]|0[1-9])[/](1[1]|0[469])|(2[0-8]|1[0-9]|0[1-9])[/](0[2]))[/][0-9]{4}[ ](2[0-3]|1[0-9]|0[0-9]):[0-5][0-9]:[0-5][0-9]"><br></td></tr>
      <tr><td><p style="display:inline">Data Up Until: (dd/mm/yyyy hh:mm:ss) </p></td><td><input id="dateUntil" name="dateUntil" type="text" pattern="((3[01]|[12][0-9]|0[1-9])[/](1[02]|0[13578])|(3[0]|[12][0-9]|0[1-9])[/](1[1]|0[469])|(2[0-8]|1[0-9]|0[1-9])[/](0[2]))[/][0-9]{4}[ ](2[0-3]|1[0-9]|0[0-9]):[0-5][0-9]:[0-5][0-9]"><br></td></tr>
