...
<script>permission = 'scientist';</script>
 ...
 <form action="executeSearch.jsp" method="post">
     ...
     <tr><td> <p style="display:inline">Sensor Type: </p></td><td><input type="text" size="32" name="stype" maxlength="32"  placeholder="Sensor Type"><br></td></tr>
      ...
      <tr><td><p style="display:inline">Data Since: (mm/dd/yyyy)</p></td><td><input size="32" type="text" name="dateSince" maxlength="32"  placeholder="Data Since"><br></td></tr>
      <tr><td><p style="display:inline">Data Up Until: (mm/dd/yyyy) </p></td><td><input size="32" type="text" name="dateUntil" maxlength="32" placeholder="Datil Up Until"><br></td></tr>
